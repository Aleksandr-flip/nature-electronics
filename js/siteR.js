...
function alertNum() {
    ...
    function clearAll() {
        ...
        if (a < 0 || b < 0 || a == 0 || b == 0) {
            ...
            let p;
            p = document.getElementById('out');
            out.textContent = 'Эквивалентное сопротивление не может быть больше сопротивления резистора';
            ...
            let p;
            p = document.getElementById('out');
            out.textContent = 'Подключение второго резистора не требуется';
            ...
            if (num > 0) {
                let p;
                p = document.getElementById('out');
                out.textContent = 'Расчет выполнен Rд = ' + num + ' kOm';
            }
